drop table dev.dev_temp_msj_risk_jdata_feature_user_sku_dim_v3_predict;
create table if not exists dev.dev_temp_msj_risk_jdata_feature_user_sku_dim_v3_predict stored as orc as select
